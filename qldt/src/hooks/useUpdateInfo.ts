...
export const useUpdateInfo = () => {
  ...
  const updateContactInfo = useCallback(async (contactInfo: ContactInfo) => {
    try {
      setLoading(true);
      const updatedInfo = await updateInfoService.updateContactInfo(contactInfo);
  ...
  const updateAddressInfo = useCallback(async (addressInfo: AddressInfo) => {
    try {
      setLoading(true);
      const updatedInfo = await updateInfoService.updateAddressInfo(addressInfo);
  ...
  const updateFamilyInfo = useCallback(async (familyInfo: FamilyInfo) => {
    try {
      setLoading(true);
      const updatedInfo = await updateInfoService.updateFamilyInfo(familyInfo);
  ...
  const updateAccountInfo = useCallback(async (accountInfo: AccountInfo) => {
    try {
      setLoading(true);
